...
- **Run container**: `docker run -e OPENAI_API_KEY=$OPENAI_API_KEY -v $(pwd)/computer_use_demo:/home/computeruse/computer_use_demo/ -v $HOME/.openai:/home/computeruse/.openai -p 5900:5900 -p 8501:8501 -p 6080:6080 -p 8080:8080 -it computer-use-demo:local`
